# This code is based on an original implementation found at https://github.com/pytorch/vision/blob/main/references/classification/utils.py
...
# Added Directory check to ensure the directory exists
